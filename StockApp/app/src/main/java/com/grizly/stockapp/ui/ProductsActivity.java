...
//        productList = Product.getPrefArraylist(Config.PREF_KEY_LIST_PRODUCTS, this);
        ...
        productList.add(new Product("100", "", "", "Pen"));
        productList.add(new Product("150", "", "", "Pencil"));
        productList.add(new Product("80", "", "", "Bag"));
        productList.add(new Product("700", "", "", "Ruler"));
        productList.add(new Product("70", "", "", "Bic"));
        productList.add(new Product("120", "", "", "Gomme"));
        productList.add(new Product("140", "", "", "Food"));

        xvxv = Product.getPrefArraylist(Config.PREF_KEY_LIST_PRODUCTS, this);
